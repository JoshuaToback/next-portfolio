...
import Joshua from "@/images/headshot.png";
        ...
        >
          ...
          <div>
            <Link
              ...
              offset={-70}
              duration={500}
              className="px-6 cursor-pointer inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <a
              href="https://drive.google.com/file/d/1H0t-tEsagWaszCAuThQVJRcqgcocXNHe/view?usp=sharing"
              target="_blank"
